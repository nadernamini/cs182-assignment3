...
if [ ! -f "capita.py" ]; then
   echo -e "\e[31mWARNING!!! 'capita.py' does not exist. It doesn't look like this submission is complete\e[39m."
fi

zip -r submission.zip "models/" "1 Language Modeling.ipynb" "2 Summarization.ipynb" "transformer_layers.py" "transformer_attention.py" "transformer.py" "capita.py"
